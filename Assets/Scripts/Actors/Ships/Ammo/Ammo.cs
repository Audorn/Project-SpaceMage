...
{
    /// <summary>
    /// A single round fired from a weapon or spellgear.
    /// </summary>
    public class Ammo : MonoBehaviour
    {
        ...
        public Ammo ActivateInPool(Vector3 position, Quaternion quaternion, Transform target, Vector2 parentVelocity, HandleMomentum momentum)
        {
