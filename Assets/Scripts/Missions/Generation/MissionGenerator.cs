...
namespace SpaceMage.Missions
{
    public class MissionGenerator : MonoBehaviour
    {
        ...
        private IEnumerator _initialize()
        {
            ...
            GameObject go = Instantiate(PrefabManager.MissionPrefab, Vector3.zero, Quaternion.identity);
        ...
        private IEnumerator _createPlayer()
        {
            ...
            if (hasSplitMapModifier)
            {
                ...
                spawnPoint.x -= PrefabManager.DefaultObstacleThickness + PrefabManager.DefaultSplitMapGapThickness / 2 + MissionManager.CurrentMission.MapSize.x / 2;
        ...
        {
            MissionGeneratorStateHandler.RegisterActiveMissionGenerator(this);
            StartCoroutine(_exitMission());
        }
        private IEnumerator _exitMission()
        {
            // Do work here.
            Debug.Log("Mission generator working...");
        ...
        private void Start()
        {
            ...
            MissionGeneratorStateHandler.Singleton.ExitingMission.AddListener(exitMission);
        }
    }
}